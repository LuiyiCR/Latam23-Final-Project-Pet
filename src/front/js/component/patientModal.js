...
const PatientModal = ({ showModal, handleCloseModal, handleInputChange, handleFileChange, handleAddPet, newPetData: propNewPetData, errorMessages: propErrorMessages }) => {
